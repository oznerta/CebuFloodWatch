...
export const METRO_CEBU_LANDMARKS: CebuLandmark[] = [
  ...
  {
    id: 'uc_banilad',
    name: 'University of Cebu - Banilad Campus (UC-B)',
    category: 'landmark',
    barangay: 'Banilad',
    latitude: 10.3387,
    longitude: 123.9118,
    description: 'Major university campus along Gov. M. Cuenco Avenue in Banilad.',
    searchTags: ['uc', 'uc-b', 'uc banilad', 'university of cebu', 'banilad', 'cuenco', 'webmasters'],
  },
  {
    id: 'cit_university',
    ...
    latitude: 10.2942,
    longitude: 123.8697,
    description: 'Engineering and technology university in N. Bacalso corridor.',
