          ...
          <div className="bg-white border border-gray-200 hover:border-gray-300 rounded-3xl p-6 shadow-xs flex flex-col justify-between space-y-6 transition-all">
            <div className="space-y-4">
              <div className="flex items-start justify-between">
                ...
                <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider ${namriaUrl.trim() ? 'bg-blue-50 text-blue-700 border border-blue-200' : 'bg-emerald-50 text-emerald-700 border border-emerald-200'}`}>
                  {namriaUrl.trim() ? 'Configured Webhook' : 'Live (Harmonic Pier 1)'}
                </span>
              </div>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex items-center justify-between mb-1.5">
                    <label className="text-xs font-bold text-gray-700">NAMRIA Webhook Endpoint URL (Optional)</label>
                    <span className="text-[10px] font-mono text-gray-400">HTTPS POST/GET</span>
                  </div>
                  <input
                    type="text"
                    value={namriaUrl}
                    placeholder="Leave blank for live Cebu Port Pier 1 harmonic tidal feed"
